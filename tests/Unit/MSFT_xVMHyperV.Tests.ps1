...
$script:dscResourceName = 'MSFT_xVMHyperV'
...
try
{
    InModuleScope $script:dscResourceName {
        Describe 'xVMHyper-V' {
            ...
            function Get-VM
            {
                [CmdletBinding()] param( [Parameter(ValueFromRemainingArguments)] $Name)
            }
            ...
            function Set-VM
            {
                param ( $Name, $AutomaticCheckpointsEnabled )
            }
            function Stop-VM
            {
            }
            ...
            {
                param ([Parameter(ValueFromPipeline)] $VM, $Name)
            }
