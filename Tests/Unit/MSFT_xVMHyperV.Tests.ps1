...
Describe 'xVMHyper-V' {
    InModuleScope $ModuleName {
        ...
        Context 'Validates Set-TargetResource Method' {
            ...
            # It 'Does call "Set-VM" when "AutomaticCheckpointsEnabled" = "$true" and "AutomaticCheckpointsEnabled" = "$false" specified' {
            #     Set-TargetResource -Name 'VMWithAutomaticCheckpoints' -AutomaticCheckpointsEnabled $false @testParams
            #     Assert-MockCalled -CommandName Set-VM -Exactly -Times 1 -Scope It
            # }
